...
const conversationStarters = [
    {
        id: 1,
        propertyAddress: "1500 Market St. Philadelphia, PA",
...
export default function GetStarted() {
  ...
  const ConversationStarter = ({ propertyAddress, propertyType }: {
    id: number;
    propertyAddress: string;
    propertyType: string;
  }) => {
    // Icon selection based on propertyType
    const getIcon = () => {
      ...
      // Default to house icon (including when propertyType is "Residential")
      return (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    return (
      ...
      >
        <div className={`${address === propertyAddress ? "text-orange-500" : "text-gray-400"} flex-shrink-0`}>
          {getIcon()}
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-900">
      ...
      <main className="container mx-auto px-4 flex flex-col items-center justify-center min-h-[80vh] py-12">
        <div className="w-full space-y-8 mb-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 flex justify-center flex-col items-center">
